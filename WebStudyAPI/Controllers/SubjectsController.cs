...
namespace WebStudyAPI.Controllers
{
    ...
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(FiendContext context)
        {
            _context = context;
        }
        ...
        public async Task<List<Subject>> Get()
        {
            return _context.Subjects != null ?
                          await _context.Subjects.ToListAsync() : null;
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subjects != null ? 
                          ...
                          Problem("Entity set 'FiendContext.Subjects'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FiendContext.Subjects'  is null.");
            }
            var subject = await _context.Subjects.FindAsync(id);
            if (subject != null)
            {
